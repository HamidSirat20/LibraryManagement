...
namespace LibraryManagement.WebAPI.Services.Implementations;
    public class AuthorService : IAuthorService
    {
        ...
        public AuthorService(LibraryDbContext context, ILogger<AuthorService> logger, IAuthorMapper authorMapper)
        {
        ...
        public async Task<PaginatedResponse<AuthorReadDto>> ListAllAuthorAsync(QueryOptions queryOptions)
        {
        ...
        public async Task<PaginatedResponse<AuthorWithBooksDto>> ListAllAuthorsWithBookAsync(QueryOptions queryOptions)
        {
            using var _ = _logger.BeginScope("Listing authors");
            try
            {
