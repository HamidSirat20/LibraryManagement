...
public class PublishersController : ControllerBase
{
    ...
    public PublishersController(IPublishersService publisherService, IPublishersMapper publisherMapper, ProblemDetailsFactory problemDetailsFactory, IPropertyCheckerService propertyCheckerService, ILogger<PublishersService> logger)
    {
