...
public class AuthorController : ControllerBase
{
    ...
    public AuthorController(IAuthorService authorService, ILogger<AuthorController> logger, IAuthorMapper authorMapper, ProblemDetailsFactory problemDetailsFactory)
    {
